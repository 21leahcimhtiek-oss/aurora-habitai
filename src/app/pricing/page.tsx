  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      <nav className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <Link href="/" className="text-xl font-bold">Aurora Rayes Habit Agent</Link>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <div className="bg-violet-600/10 border border-violet-500 rounded-2xl p-8 text-left relative">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> AI habit coaching</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Streak tracking</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Daily check-ins</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Progress analytics</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Smart reminders</li>
