  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-400 mb-10">Your Aurora Rayes Habit Agent AI assistant is ready.</p>
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="text-gray-400 text-sm mb-1">AI habit coaching</div>
            <div className="text-2xl font-bold text-white">Ready</div>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="text-gray-400 text-sm mb-1">Streak tracking</div>
            <div className="text-2xl font-bold text-white">Ready</div>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="text-gray-400 text-sm mb-1">Daily check-ins</div>
            <div className="text-2xl font-bold text-white">Ready</div>
          </div>
        </div>
